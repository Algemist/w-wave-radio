...
/* harmony import */ var _components_podcast__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/podcast */ "./src/js/components/podcast.js");
/* harmony import */ var _components_podcast__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_podcast__WEBPACK_IMPORTED_MODULE_2__);
...
var element = document.getElementById('broadcast-select');
...
/***/ "./src/js/components/podcast.js":
/*!**************************************!*\
  !*** ./src/js/components/podcast.js ***!
  \**************************************/
/***/ (() => {

var btn = document.querySelector('.podcast__btn');
...
if (btn) {
  var card = document.querySelectorAll('.podcast-card_hidden');
...
if (tabcontents) {
  var btns = document.querySelectorAll('.tabs__nav-btn');
  btns.forEach(function (el) {
    el.addEventListener('click', function () {
      var activeBtn = document.querySelector('.tabs__nav-btn.active');
      var activeContent = document.querySelector("[data-content='".concat(activeBtn.getAttribute('data-tabs'), "']"));
      activeBtn.classList.remove('active');
      activeContent.classList.remove('active');
      el.classList.add('active');
      var content = document.querySelector("[data-content='".concat(el.getAttribute('data-tabs'), "']"));
...
;
var streamBtn = document.querySelector('.stream-btn');
var streamContainer = document.querySelector('.live-status');
var streamStatusBtns = document.querySelectorAll('.live-status__btn');
streamBtn.addEventListener('click', function () {
  streamContainer.classList.toggle('active');
  streamStatusBtns.forEach(function (el) {
    el.classList.toggle('active');
  });
});
